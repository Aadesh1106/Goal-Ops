...
export default function EditGoalPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Edit Goal"
        subtitle="Update your goal details. Only draft and rejected goals can be edited."
        action={
      ...
      <Card className="max-w-2xl">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div>
            <label className="form-label" htmlFor="edit-thrust">Thrust Area</label>
            <select id="edit-thrust" className="form-input" {...register('thrust_area')}>
          ...
          <div>
            <label className="form-label" htmlFor="edit-title">Goal Title</label>
            <input id="edit-title" className="form-input" {...register('title')} />
          ...
          <div>
            ...
            <textarea id="edit-desc" className="form-input" rows={3} {...register('description')} />
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="form-label" htmlFor="edit-target">Target Value</label>
              <input id="edit-target" type="number" step="0.01" className="form-input"
